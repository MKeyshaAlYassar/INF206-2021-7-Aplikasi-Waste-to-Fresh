...
import { konversiSampah, HitungKonversiSampah } from "./../../../utils/KonversiSampah"
  ...
  return (
    <div className='cek-konversi-sampah-container'>
      ...
      <div className='header-cek-konversi-sampah'>
        <p className="judul-fitur-cek-konversi-sampah">Tukar Sampah</p>
        <p className="deskripsi-fitur-cek-konversi-sampah">Cek penukaran sampah Anda akan
      menghasilkan berapa poin</p>
      </div>
      ...
      <div className='total-poin-cek-konversi-sampah-container'>
        <p className='judul-total-poin-cek-konversi-sampah-container'>Total Poin</p>
        <p className='judul-poin-cek-konversi-sampah-container'>{totalKonversi}</p>
      </div>
    </div>
  );
}
